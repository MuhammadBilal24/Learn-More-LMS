<?php
		include('header.php');
		$data=$this->db->get('ilets_course')->result()[0];
		?>
					...
					<div class="row">
						<aside class="col-md-3">
							...
							<div class="widget widget_professor-info">
								...
								<figure>
									<a href="#"><img src="<?=base_url()?>assets/extra-images/our-courses-author.jpg" alt=""></a>
								</figure>
								<div class="wm-Professor-info">
									<h6><a href="#"><?= $data->instructor?></a></h6>
						...
						<div class="col-md-9">
							<div class="wm-blog-single wm-courses">
								<figure class="wm-detail-thumb">
									<img src="<?=base_url()?>assets/extra-images/our-courses1.jpg" alt="">
								</figure>
								<div class="wm-blog-author wm-ourcourses">
									<div class="wm-blogauthor-left">
										<img src="<?=base_url()?>assets/extra-images/our-courses-author.jpg" alt="">
										<a class="wm-authorpost" href="#"><?= $data->instructor?></a>
									</div>
				                            ...
				                            <ul>
					                            <li>
					                            	<h4><a href="#">Brenda F. Oglesby</a></h4>
					                              	<figure><a href="blog-detail.html"><img src="<?=base_url()?>assets/extra-images/reviews-1.jpg" alt=""></a></figure>
				                            ...
				                            <ul>
					                            <li>
					                            	<h4><a href="#">Gloria E. Larsen</a></h4>
					                              	<figure><a href="blog-detail.html"><img src="<?=base_url()?>assets/extra-images/reviews-2.jpg" alt=""></a></figure>
									                <div class="wm-reviews-text">
														<div class="wm-rating">
															<span class="rating-box" style="width:100%"></span>											
														</div>
				                    ...
				                    <li>
				                       	<div class="thumblist">
				                            <ul>
					                            <li>
					                            	<h4><a href="#">Gloria E. Larsen</a></h4>
					                              	<figure><a href="blog-detail.html"><img src="<?=base_url()?>assets/extra-images/reviews-3.jpg" alt=""></a></figure>
									                <div class="wm-reviews-text">
														<div class="wm-rating">
															<span class="rating-box" style="width:100%"></span>											
														</div>
								...
								<ul>
									<li>
										<div class="wm-author-detail wm-courses-authorinfo">
											<figure>
												<a href="#"><img src="<?=base_url()?>assets/extra-images/author-blog-2.jpg" alt=""></a>
											</figure>
									...
									<li>
										<div class="wm-author-detail wm-courses-authorinfo">
											<figure>
												<a href="#"><img src="<?=base_url()?>assets/extra-images/author-blog-7.jpg" alt=""></a>
											</figure>
											<div class="wm-author-text">
